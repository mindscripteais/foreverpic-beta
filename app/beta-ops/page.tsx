...
import {
  ...
  Trash2, Eye, BarChart3, Loader2, X
} from 'lucide-react'
...
export default function BetaOpsPage() {
  ...
  // Simple protection: non-admin users see 404-like page
  if (!session?.user?.isAdmin) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-cream-100">
        <div className="text-center">
          <p className="text-warm-600 text-lg">Pagina non trovata</p>
